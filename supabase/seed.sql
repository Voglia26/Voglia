...
-- items: 3 rows
insert into items (id, quotation_id, name, sku, description, specs, photo_urls, position, created_at) values ('5b9e3fb8-87a8-423b-a112-3f6b6e84c738', '529b4658-9a79-4807-bd7a-2a09c2ed5510', 'Hola', NULL, NULL, NULL, '{}', 0, '2026-04-24T19:37:33.975589+00:00') on conflict (id) do nothing;
