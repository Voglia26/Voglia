...
export async function addItem(formData: FormData) {
  ...
  const specs: ItemSpecs = {
    gold_weight: parseNumber(formData.get("gold_weight")),
    gold_type: (String(formData.get("gold_type") ?? "").trim() || null),
    stone_type: (String(formData.get("stone_type") ?? "").trim() || null),
    diamond_carat_weight: parseNumber(formData.get("diamond_carat_weight")),
    gemstone_carat_weight: (String(formData.get("gemstone_carat_weight") ?? "").trim() || null),
    custom_carat_weight: (String(formData.get("custom_carat_weight") ?? "").trim() || null),
    additional_details: (String(formData.get("additional_details") ?? "").trim() || null),
  };
